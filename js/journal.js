...
Entry.prototype.consonants = function(bodyEntry) {
  ...
  for (var i = 0; i <= bodyEntry.length; i += 1) {
    if (bodyEntry.charAt(i) == "b" || bodyEntry.charAt(i) == "c" || bodyEntry.charAt(i) == "d" || bodyEntry.charAt(i) == "f" || bodyEntry.charAt(i) == "g" || bodyEntry.charAt(i) == "h" || bodyEntry.charAt(i) == "j" || bodyEntry.charAt(i) == "k" || bodyEntry.charAt(i) == "l" || bodyEntry.charAt(i) == "m" || bodyEntry.charAt(i) == "n" || bodyEntry.charAt(i) == "p" || bodyEntry.charAt(i) == "q" || bodyEntry.charAt(i) == "r" || bodyEntry.charAt(i) == "s" || bodyEntry.charAt(i) == "t" || bodyEntry.charAt(i) == "v" || bodyEntry.charAt(i) == "w" || bodyEntry.charAt(i) == "x" || bodyEntry.charAt(i) == "y" || bodyEntry.charAt(i) == "z") {
      consonantsCount += 1;
    } 
  }
